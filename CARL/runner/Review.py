...
import numpy as np
from CARL.runner.ExtractData import Dataset
from CARL.runner.GetTest import get_test_list
...
def train_model():
    ...
    v = tf.Variable(tf.truncated_normal([latent_dim * 3, v_dim], stddev=0.3), name="review_v")
